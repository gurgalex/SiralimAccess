...
OCR_UI_SYSTEMS = Union[
    OCRCreatureRecorderSelectFirst, OCRCreatureRecorderSwapWith, OCRGodForgeSelectSystem, OCRCreaturesDisplaySystem, OcrSummoningSystem, OcrUnknownArea, CodexGeneric, OCRRealmSelect, PerkScreen, AnointmentClaimUI, FieldItemSelectUI]
