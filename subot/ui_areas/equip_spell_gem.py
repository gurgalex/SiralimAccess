...
class EquipSpellGemUI(SpeakAuto):
    mode = OCRMode.EQUIP_SPELL
    ...
    def speak_auto(self):
        ...
        new_spell_text = "new" if self.spell_info_component.is_new_spell else ""
        spell_gem_text = f"{self.spell_info_component.spell_name}, {new_spell_text}, {self.spell_info_component.spell_class.name} class"
